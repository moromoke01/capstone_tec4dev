    ...
    <>
      ...
      <div className='containerbody'>
        <div className='hero-section-content'>
          <h1 className="typing-text">Unleashing Your Tech Skills Potential</h1>
        ...
        <div className='hero-button'>
          <a href="/signUp">
            <button type="button" className="focus:outline-none text-white bg-customPurple hover:bg-customDarkPurple focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
              Take Test
            </button>
          </a>
        </div>
        <div className='hero-image'>
          <img src={image} alt="Home Groupie" />
        </div>
      ...
      <div className="bg-[#27AE6024] px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-5">
          <div className="m-5 bg-white rounded-lg p-6 shadow-lg">
            <h2 className="font-bold text-2xl md:text-4xl mb-4">Our Mission</h2>
            <h4 className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-4">
          ...
          <div className="m-5 bg-white rounded-lg p-6 shadow-lg">
            <h2 className="font-bold text-2xl md:text-4xl mb-4">Our Commitment To Excellence</h2>
            <h4 className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-4">
          ...
          <div className="m-5 bg-white rounded-lg p-6 shadow-lg">
            <h2 className="font-bold text-2xl md:text-4xl mb-4">Take Your Test</h2>
            <h4 className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-4">
          ...
          <div className="m-5 bg-white rounded-lg p-6 shadow-lg">
            <h2 className="font-bold text-2xl md:text-4xl mb-4">Accurate Career Recommendations</h2>
            <h4 className="text-lg md:text-xl lg:text-2xl xl:text-3xl mb-4">
      ...
      <aside className="newsletter-section p-4 my-8 bg-white border rounded-lg shadow-md sm:p-6 lg:p-8 ">
        ...
        <form id="contact-form" onSubmit={handleSubmit}>
          <div data-style="clean" className="flex items-center mb-3">
            <div data-element="fields" data-stacked="false" className="flex items-center w-full seva-fields formkit-fields">
              ...
              <button type='submit' disabled={state.submitting} className="px-5 py-3 text-sm font-medium text-center text-white bg-customPurple rounded-lg cursor-pointer hover:bg-purple-800 focus:ring-4 focus:ring-bg-customPurple ml-0">
                SUBSCRIBE
              </button>
            </div>
          </div>
